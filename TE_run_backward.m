function TE_run_backward(srcx,srcz,recx,recz,freq,T,isrc,outstep,flag)
...
save(['Gather02_',num2str(isrc),'.mat'],'gather','tout','srcx','srcz','recx','recz','dt','dx','dz','-v7.3')
save(['Wavefield02_',num2str(isrc),'.mat'],'wavefield','tout','srcx','srcz','recx','recz','dt','dx','dz','-v7.3')

...
save(['Gather00_',num2str(isrc),'.mat'],'xgather','zgather','tout','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')
if outstep(1) == 1
save(['Wavefield00_',num2str(isrc),'.mat'],'xwavefield','zwavefield','outstep','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')
end

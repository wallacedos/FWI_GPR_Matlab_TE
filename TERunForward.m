...
save(['Gather01_',num2str(isrc),'.mat'],'gather','tout','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')
save(['Wavefield01_',num2str(isrc),'.mat'],'wavefield','tout','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')

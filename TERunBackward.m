function TEGenerateData(srcloc,recloc, srcpulse, T,isrc,outstep,plotopt)
...
% run the simulation
tic;
[wavefield,gather,tout,srcx,srcz,recx,recz] = TE_model2d(ep3,mu3,sig3,x3,z3,srcloc,recloc,srcpulse,t,npml,outstep,plotopt);
disp(' ');
disp(['Total running time = ',num2str(toc/3600),' hours']);

save(['Gather02_',num2str(isrc),'.mat'],'gather','tout','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')
save(['Wavefield02_',num2str(isrc),'.mat'],'wavefield','tout','srcx','srcz','recx','recz','dt','dx','dz','x','z','-v7.3')
